...
celery_app.conf.beat_schedule = {"process_pending_tasks": {"task": "backend.app.background_tasks.student_profile_tasks.process_closed_sessions_task", "schedule": 300.0}, "recompute_lead_scores_nightly": {"task": "backend.app.background_tasks.lead_scores_task", "schedule": 86400.0}, "check_reengagement_nudges": {"task": "backend.app.background_tasks.reengagement_tasks.check_and_send_reengagement_nudges_task", "schedule": 600.0}}